<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="assets/new-logos/PRIMARY-LOCKUP-cropped-white.svg">
    <source media="(prefers-color-scheme: light)" srcset="assets/new-logos/PRIMARY-LOCKUP-cropped.svg">
    <img alt="Thoth – AI‑powered transcription of historical manuscripts" src="assets/new-logos/PRIMARY-LOCKUP-cropped.svg" width="100%" />
  </picture>
</p>
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="assets/new-logos/PRIMARY-LOCKUP-cropped-white.svg">
    <source media="(prefers-color-scheme: light)" srcset="assets/new-logos/PRIMARY-LOCKUP-cropped.svg">
    <img alt="Thoth wordmark" src="assets/new-logos/PRIMARY-LOCKUP-cropped.svg" width="420" />
  </picture>
</p>
